import numpy as np
from dSprites.dSprites_data_loader import load_dsprites
from dSprites.dSprites_model_builder import get_dsprites_model
...
def get_model_data(args):
    ...
    # Load dataset
    x_train, y_train, x_test, y_test, c_train, c_test, c_names = load_dsprites(path,
    ...
    model = get_dsprites_model(x_train, y_train, args.models_dir,
                               task=task_name + "_" + dataset_schema,
                               num_classes=n_classes,
                               )

    return model, x_train, y_train, x_test, y_test, c_train, c_test, c_names
